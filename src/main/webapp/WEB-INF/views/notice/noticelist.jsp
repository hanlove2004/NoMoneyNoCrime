...
<div class="container" id="noticecontainer">
	...
	<c:forEach var="noticelist" items="${noticelist}">
		<div>
			...
			<!-- detail -->
			<div class="notice" id="noticedetail${noticelist.num}" style="text-align: left;">
			</div>
		</div>
	</c:forEach>
	...
	<div style="margin: 0 auto; width: 300px;">
		<nav style="text-align: center;">
			<ul class="pagination pagination-sm">
				...
				<c:if test="${pg>block}">
					<li><a href="noticelist.htm?pg=1">처음</a></li>
					<li><a href="noticelist.htm?pg=${fromPage-1}"
				...
				<!-- 마지막 , 다음 페이지로 이동 -->
				<c:if test="${toPage<allPage}">
					<li><a href="noticelist.htm?pg=${toPage+1}" aria-label="Next">
							<span aria-hidden="true">&raquo;</span>
					</a></li>
