...
$(document).ready(function(){
  ...
  <style>
      div .col {padding-top: 10px; padding-bottom: 10px;}
      div .noticehead {padding-top: 50px;}
      div .col-xs-10 {border-radius: 10px; border:2px solid silver; height: 300px; overflow: auto;}
      div .col-btn {padding-top: 265px;}
