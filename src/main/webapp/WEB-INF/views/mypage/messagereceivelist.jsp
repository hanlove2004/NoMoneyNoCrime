...
<div style="height: 500px; width: 600px; margin: auto;">
	...
	<div>
			<div class="col col-xs-2">${messagereceivelist.num}</div>
			<div class="col col-xs-2">${messagereceivelist.sender}</div>
			<div class="col col-xs-5">${messagereceivelist.content}</div>
			<div class="col col-xs-3">${messagereceivelist.regdate}</div><br>
			<div><hr></div>
	</div>
	</c:forEach>
