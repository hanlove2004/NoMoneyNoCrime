		...
		function Paging(pg) {
	         $.ajax({
	            ...
	            success : function(data) {
	               ...
	               $.each(data.freelist, function(index, obj){
	                  print += "<div>";
	                  print += "<div class=\"freehead\">";
	                  print += "<div class=\"col col-xs-2\">" + obj.num + "</div>";
	                  print += "<div class=\"col col-xs-2\">" + obj.id + "</div>";
	                  print += "<div class=\"col col-xs-6\" id=\"freehead" + obj.num + "\"";
	                  print += "onclick=\"FreeDetail(" + obj.num + ")\">";
	                  print += obj.title + "</div>";
	                  print += "<div class=\"col col-xs-2\">" + obj.regdate + "</div>";
	                  print += "<div><hr></div></div>";
	                  print += "<div class=\"free\" id=\"freedetail" + obj.num + "\"></div>";
	               });
